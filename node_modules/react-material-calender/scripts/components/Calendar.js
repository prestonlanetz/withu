	...
	render: function() {
		...
		return (
			<div>
				...
				{
					(this.state.option==='month') ? <Month month={this.state.currMonth} year={this.state.currYear} events={data}/> : <Daily events={data} month={this.state.currMonth} year={this.state.currYear} />
				}	
			</div>
